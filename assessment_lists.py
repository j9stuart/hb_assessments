...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    """
    find_common_foods = (set(foods1) & (set(foods2)))
    common_food = list(find_common_foods)
    common_food.sort()
    return common_food
...
def every_other_item(items):
    ...
    """
    every_other_item_list = [item for item in items[0::2]]
...
def largest_n_items(items, n):
    ...
    """
    items.sort()
    largest_integers = [item for item in items[:-(n+1):-1]]
